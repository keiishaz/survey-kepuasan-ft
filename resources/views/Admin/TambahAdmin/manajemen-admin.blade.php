            ...
            <div class="bg-white rounded-2xl shadow-sm p-5 mb-6 border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    ...
                    <div class="md:col-span-8">
                        <label class="block text-xs font-semibold text-gray-700 mb-2">Cari Admin</label>
                        <div class="relative">
                            <input type="text" 
                    ...
                    <div class="md:col-span-4 flex items-end">
                        <a href="{{ url('/admin/tambah') }}" class="w-full bg-gradient-to-r from-medium-blue to-blue-600 text-white px-5 py-2.5 rounded-xl font-medium text-sm hover:from-dark-blue hover:to-blue-700 transition-all duration-300 shadow-sm hover:shadow-md flex items-center justify-center space-x-2">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        ...
                                        <form action="{{ route('admin.destroy', $admin->id_admin) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus admin ini?')">
                                            @csrf
                                            @method('DELETE')
