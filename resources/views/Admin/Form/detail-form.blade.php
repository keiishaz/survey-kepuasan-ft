            ...
            <div class="p-6 lg:p-8">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-label">Tingkat Penyelesaian Section</div>
                            <div class="stat-value">{{ number_format($tingkatPenyelesaian, 1) }}%</div>
                            <div class="text-xs text-gray-500">
                                @if($totalResponden == 0)
                                    Belum ada responden
                                @else
                                    {{ $totalResponden }} responden menyelesaikan form
                                @endif
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                        <h3 class="text-sm font-bold text-gray-900 mb-4">Tingkat Kepuasan Form</h3>
                    ...
                    <!-- Distribution of Satisfaction Ratings Bar Chart -->
                    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                        <h3 class="text-sm font-bold text-gray-900 mb-4">Distribusi Tingkat Kepuasan</h3>
            ...
            new Chart(satisfactionDistributionCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [
                            {{ $distribusiJawaban[1] ?? 0 }},
                            {{ $distribusiJawaban[2] ?? 0 }},
                            {{ $distribusiJawaban[3] ?? 0 }},
                ...
                options: {
                    responsive: true,
                    maintainAspectRatio: false,
                    indexAxis: 'x',  // Horizontal bars if needed - use 'y' for horizontal
                    scales: {
                        y: {
                            beginAtZero: true,
                            ticks: {
