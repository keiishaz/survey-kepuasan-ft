...
<aside class="w-64 bg-[#1E3A8A] border-r border-gray-200 fixed left-0 top-0 bottom-0 overflow-y-auto z-50 transition-all duration-300" id="sidebar">
    ...
    <nav class="p-4 space-y-1">
        ...
        <a href="{{ url('/dashboard') }}" class="nav-link flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-200 hover:text-white hover:bg-blue-600 transition-all duration-200 text-sm" data-page="dashboard">
        ...
        <a href="{{ url('/form') }}" class="nav-link flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-200 hover:text-white hover:bg-blue-600 transition-all duration-200 text-sm" data-page="form">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ url('/kategori') }}" class="nav-link flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-200 hover:text-white hover:bg-blue-600 transition-all duration-200 text-sm" data-page="kategori">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ url('/admin') }}" class="nav-link flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-200 hover:text-white hover:bg-blue-600 transition-all duration-200 text-sm" data-page="admin">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="pt-6 mt-6 border-t border-gray-700">
            ...
            <form method="POST" action="{{ route('logout') }}" id="logout-form">
                @csrf
                <a href="javascript:void(0)" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-red-400 hover:text-white hover:bg-red-600 transition-all duration-200 text-sm" onclick="confirmLogout();">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Footer -->
    <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-700 bg-[#1E3A8A]">
...
<script>
    ...
    navLinks.forEach(link => {
        ...
        if (currentPath.includes(page)) {
            ...
            link.classList.remove('text-gray-200', 'hover:bg-blue-600', 'hover:text-white');
