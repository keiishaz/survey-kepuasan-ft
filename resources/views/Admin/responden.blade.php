...
<body class="bg-gray-50 min-h-screen">
                ...
                @if($respondens->count() > 0)
                    <div class="responden-container">
                        ...
                        <div class="responden-card">
                            ...
                            <!-- Identitas Responden -->
                            <div class="mb-4">
                                <h4 class="text-xs font-medium text-gray-700 mb-2">Identitas:</h4>
                        ...
                        <div class="grid grid-cols-5 gap-2">
                            @for($i = 1; $i <= 5; $i++)
                                <div class="text-center">
                                    <div class="text-lg font-bold text-{{ $i == 1 ? 'red' : ($i == 2 ? 'orange' : ($i == 3 ? 'yellow' : ($i == 4 ? 'green' : 'emerald'))) }}-500">{{ $statistik['distribusi'][$i] }}</div>
                                    <div class="text-xs text-gray-500">Skala {{ $i }}</div>
                                </div>
                            @endfor
                        </div>
                    </div>
    ...
    <script>
        // Inisialisasi chart untuk setiap pertanyaan jika ada data
        @if(count($statistikPertanyaan) > 0)
            @foreach($statistikPertanyaan as $statistik)
                ...
                new Chart(ctx{{ $statistik['id_pertanyaan'] }}, {
                    type: 'bar',
                    data: {
                        labels: ['Skala 1', 'Skala 2', 'Skala 3', 'Skala 4', 'Skala 5'],
                        datasets: [{
                            ...
                            backgroundColor: [
                                'rgba(239, 68, 68, 0.7)',    // Merah untuk 1
                                'rgba(249, 115, 22, 0.7)',   // Oranye untuk 2
                                'rgba(234, 179, 8, 0.7)',    // Kuning untuk 3
                                'rgba(34, 197, 94, 0.7)',    // Hijau untuk 4
                                'rgba(34, 197, 94, 0.7)'     // Hijau untuk 5
                            ],
                            borderColor: [
                                'rgba(239, 68, 68, 1)',
                                'rgba(249, 115, 22, 1)',
