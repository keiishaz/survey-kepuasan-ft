    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 lg:ml-72 p-6 lg:p-8 lg:pr-6">
            ...
            <div class="mb-6 lg:mt-0 mt-16">
                <h1 class="text-xl font-bold text-gray-900 mb-1">Manajemen Kategori</h1>
                <p class="text-xs text-gray-600">Kelola kategori form survey dalam sistem</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm p-4 mb-6 border border-gray-100">
                <div class="flex flex-col sm:flex-row gap-3 items-start sm:items-end">
                    ...
                    <div class="flex-1 w-full">
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">Cari Kategori</label>
                        <div class="relative">
                            <input type="text" 
                                   placeholder="Cari..." 
                    ...
                    <button class="bg-gradient-to-r from-medium-blue to-blue-600 text-white px-4 py-2 rounded-xl font-medium text-sm hover:from-dark-blue hover:to-blue-700 transition-all duration-300 shadow-sm hover:shadow-md flex items-center space-x-1.5 whitespace-nowrap">
                        ...
                        <a href="{{ url('/kategori/tambah') }}" class="...">Tambah</a>
                    </button>
                </div>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 card-hover">
                    <div class="flex items-start justify-between mb-3">
                        <div class="flex items-center space-x-2.5">
                            ...
                            <div>
                                <h3 class="text-sm font-bold text-gray-900">{{ $kategori->nama }}</h3>
                    ...
                    <div class="flex space-x-2 pt-3 border-t border-gray-100">
                        <a href="{{ route('kategori.edit', $kategori->id_kategori) }}" class="flex-1 flex items-center justify-center space-x-1 bg-blue-50 text-blue-600 py-2 px-3 rounded-lg font-medium hover:bg-blue-100 transition-all duration-200 text-xs">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                            </svg>
                            <span>Edit</span>
                        </a>
                        <a href="{{ route('kategori.hapus', $kategori->id_kategori) }}" class="flex-1 flex items-center justify-center space-x-1 bg-red-50 text-red-600 py-2 px-3 rounded-lg font-medium hover:bg-red-100 transition-all duration-200 text-xs">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
